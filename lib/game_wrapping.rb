...
class GameDaemon
  ...
  def initialize
    ...
    autogenerated = does_player_want_to_automate_ship_creation
    @player = Navy.new("player", autogenerated) # ditto for player
    @player.board.show_initial_player_board if autogenerated == true
  end
